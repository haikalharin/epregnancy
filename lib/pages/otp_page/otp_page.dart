              ...
              listener: (context, state) {
                if (state.submitStatus == FormzStatus.submissionFailure) {
                  if (state.errorMessage != null &&
                      state.errorMessage!.contains('Anda sudah memasukkan kode OTP sebanyak 3 kali')) {
                    setState(() {
                      isToMuch = true;
                      isResend = false;
                      isResendLoading = false;
                      _current = state.differentTime ?? 0;
                      _start = state.differentTime ?? 0;
                      sub = CountdownTimer(
                        Duration(seconds: state.differentTime ?? 0),
                        const Duration(seconds: 1),
                      ).listen(null);
                      sub.resume();
                    });
                  ...
                  if (widget.from == "forgotPassword") {
                    Navigator.of(context).pushNamed(RouteName.newPasswordPage,
                          ...
                          children: [
                            ...
                            Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    widget.userName!.contains("@")
                                        ? "Ketik kode 6 digit yang telah kami kirimkan ke email"
                                      ...
                                      : isToMuch
                                          ? Padding(
                                              padding: EdgeInsets.only(
                                                  ...
                                                  right: 12.w),
                                              child: Text(
                                                "Anda sudah memasukan kode OTP sebanyak 3 kali. Silahkan coba lagi setelah 60 menit",
                                                maxLines: 2,
                                                style: TextStyle(
                                                    color: Colors.red,
                                                    fontSize: 12.sp,
                                  ...
                                  isResend
                                      ...
                                      : Column(
                                          children: [
                                            Text(
                                                "Menunggu untuk mengirim ulang OTP selama"),
                                            SizedBox(
                                              height: 10.h,
                                            ),
                                            Text(
                                              "${formatedTime(timeInSecond: _current)}",
                                              style: TextStyle(
                                                  color: Colors.black,
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 14.sp),
                                  ...
                                  isResend
                                      ? InkWell(
                                          onTap: () {
                                            ...
                                            Injector.resolve<OtpPageBloc>().add(
                                                RequestResendOtp(
                                                    true, widget.userName));
                                          },
