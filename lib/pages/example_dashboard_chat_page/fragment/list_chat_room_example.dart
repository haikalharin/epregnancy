...
class ListChatRoomExample extends StatefulWidget {
  @override
  _ListChatRoomExampleState createState() => _ListChatRoomExampleState();
}

class _ListChatRoomExampleState extends State<ListChatRoomExample> {
  ...
  void deleteChatRoom(String personUid) async {
    ...
    if (value == 'delete') {
      EventChatRoomExample.deleteChatRoom(myUid: _myPerson!.uid, personUid: personUid);
    }
  }
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => ChatRoomExample(arguments: {'room': room})));
        },
        onLongPress: () {
