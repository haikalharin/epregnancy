    ...
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
                onPressed: () {
                  Navigator.pushNamed(
                      context, RouteName.poinActivityPage, arguments: _point);
                },
                icon: Icon(
        ...
        body: BlocListener<PoinBloc, PoinState>(
          listener: (context, state) {
            print('state status :  ${state.status} || type : ${state
                .type} || day : ${state.dayForPayload}');
          ...
          child: BlocBuilder<PoinBloc, PoinState>(
            builder: (context, state) {
              return SingleChildScrollView(
                            ...
                            //         EpregnancyColors.blueDark)),
                              ...
                              onPressed: state.checkInDoneForToday ?? false
                                ...
                                Injector.resolve<PoinBloc>().add(
                                    PoinCheckInEvent(state.dayForPayload));
                              },
                              child: Center(
                                child: Text(
                                  ...
                                  style: TextStyle(
                                      color: state.checkInDoneForToday ?? false
                                          ? EpregnancyColors.blueDark
                                          : Colors.white),
                                ),
                              )),
                ...
                // SizedBox(height: 20,),
                // ReedemItemCard(),
                const PoinInfoCard(title: "Baca Artikel", subtitle: "Anda akan mendapatkan 50 POIN untuk setiap\nartikel yang dibaca", image: "assets/imgNews.png", game:  true,),
                const PoinInfoCard(title: "Kunjungi Puskesmas", subtitle: "Anda akan mendapatkan 10 POIN untuk setiap\nkunjungan ke puskesmas dalam sehari", image: "assets/imgKunjungan.png"),
