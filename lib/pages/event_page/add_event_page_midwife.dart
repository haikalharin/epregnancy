...
class AddEventPageMidwife extends StatefulWidget {
  const AddEventPageMidwife({Key? key, this.consulType}) : super(key: key);
  final String? consulType;

  @override
  _AddEventPageMidwifeState createState() => _AddEventPageMidwifeState();
}
...
class _AddEventPageMidwifeState extends State<AddEventPageMidwife> {
                      ...
                      child: Container(
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: (widget.consulType == StringConstant.visitHospital ||
                                widget.consulType == StringConstant.other)
                                ? (state.status.isValidated && state.isTimeCorrect == true
                          ...
                          onPressed: (widget.consulType == StringConstant.visitHospital ||
                              widget.consulType == StringConstant.other)
                              ? (state.status.isValidated && state.isTimeCorrect == true
                              ? () {
                            Injector.resolve<EventPageBloc>().add(EventAddSubmitted());
                          }
                              : null)
                              : (state.status.isValidated
                              ? () {
