...
class VisitCardItemList extends StatelessWidget {
  const VisitCardItemList({Key? key, this.withButton = false, this.userVisitModel}) : super(key: key);
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text('Kehamilan ${userVisitModel?.user?.pregnancyWeek??'0'} Minggu', style: TextStyle(
