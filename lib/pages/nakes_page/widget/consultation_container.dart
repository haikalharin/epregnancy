          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(child: Container(
                height: 32.h,
                width: 32.w,
                decoration: consultationEnum == ConsultationEnum.newest ? const BoxDecoration(
                ...
                child: Center(
                  child: Text(value.toString(), style: TextStyle(color: consultationEnum == ConsultationEnum.newest ? Colors.white : EpregnancyColors.primer, fontWeight: FontWeight.w700, fontSize: 16.sp),),
                ),
              ))
            ],
          ),
